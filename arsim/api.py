...
class SoSAPI:
    ...
    def add_task(self, t_type, position, weight, /, on_finished=None) -> None:
        self._scene.tasks.append(Task(self._scene, t_type, position, weight, on_finished=on_finished))  # type: ignore
