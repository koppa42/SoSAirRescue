...
class Airport(Position):
    def __init__(self, name: str, longitude: float, latitude: float, helicopter_area: float, fixed_area: float):
        super().__init__(name, longitude, latitude, helicopter_area, fixed_area, 0, 0, 0, 0, 0, 0, 0)
...
class DisasterArea(Position):
    def __init__(self, name: str, longitude: float, latitude: float, helicopter_area: float, fixed_area: float, 
        ...
        super().__init__(name, longitude, latitude, helicopter_area, fixed_area, air_work_area, supply, 
                         rescue_people, trapped_people, device, patient, water)
