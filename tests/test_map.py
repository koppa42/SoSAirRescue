...
class TestPosition(unittest.TestCase):
    ...
    def test_distance_cal(self):
        self.assertAlmostEqual(m.Position.distance(self.pos[0], self.pos[1]), 7933.501372, delta=0.1)
        self.assertAlmostEqual(m.Position.distance(self.pos[0], self.pos[2]), 8228.199046, delta=0.1)
        self.assertAlmostEqual(m.Position.distance(self.pos[0], self.pos[3]), 7739.460387, delta=0.1)
        self.assertAlmostEqual(m.Position.distance(self.pos[1], self.pos[2]), 342.026112, delta=0.1)
